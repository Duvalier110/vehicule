                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <form method="POST" action="{{url('user/' .$user->id)}}" novalidate="novalidate">
                                        @csrf
                                            {{method_field('PATCH')}}
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" value="{{$user->name}}" name="name" placeholder="name">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <input type="string" class="form-control input-default" value="{{$user->password}}" name="password" placeholder="password">
                                            </div>
