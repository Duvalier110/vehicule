                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$paiement->created}}</td>
                                                <td>{{$paiement->modify}}</td>
                                                <td>{{$paiement->deleted}}</td>
                                                <td>
                                                    <form method="POST" action="{{url('/paiement/delete/' .$paiement->id)}}">
                                                        {{method_field('DELETE')}}
                                                        @csrf

                                                        <a href="{{url('paiement/' .$paiement->id. '/edit')}}">
