        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="bootstrap-modal">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#basicModal">Ajouter un Type Véhicule</button>
                    <!-- Modal -->
                    <div class="modal fade" id="basicModal">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{url('type_vehicule')}}">
                                    @csrf
                                    <div class="form-group">
                                        <input type="text" class="form-control input-default" name="name" placeholder="entrez le nom">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control input-rounded" name="description" placeholder="entrez la description">
                                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> Types de véhicule</h4>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <!-- <a href="{{url('type_vehicule/create')}}">
                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$type_vehicule->name}}</td>
                                            <td>{{$type_vehicule->description}}</td>

                                            <td>
                                                <form method="POST" action="{{url('/type_vehicule/delete/' .$type_vehicule->id)}}">
                                                    {{method_field('DELETE')}}
                                                    @csrf

                                                    <a href="{{url('type_vehicule/' .$type_vehicule->id. '/edit')}}">
