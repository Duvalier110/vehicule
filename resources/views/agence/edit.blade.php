                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                             <!-- field patch permet de modifier et renvoie au post pour sauvegarder  -->               
                                        <form method="POST" action="{{url('agence/' .$agence->id)}}" novalidate="novalidate">
                                            @csrf
                                            {{method_field('PATCH')}}
                                            <div class="form-group">
                                                <input type="text" class="form-control input-default" value="{{$agence->name}}" name="name" placeholder="entrez le nom">
                                            </div>
                                            <div class="form-group">
