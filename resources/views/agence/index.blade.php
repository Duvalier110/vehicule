        ...
        ***********************************-->
        <div class="content-body">
            <div class="container-fluid">
                ...
                <!-- notification d'ajout avec succes ,modifier et supprimer -->
                @if(session('ajouter'))
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Ajouter une agence</h1>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form method="POST" action="{{url('/agence/delete/' .$agence->id)}}">
                                                    ...
                                                    <a href="{{url('agence/' .$agence->id. '/edit')}}">
